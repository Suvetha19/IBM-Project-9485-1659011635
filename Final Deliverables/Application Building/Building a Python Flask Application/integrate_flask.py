...
API_KEY = "rNBLorJCjC6j1RLCEyuaZ3g5unURcl9bo0p3wrnfAVS7"
...
def predict():
	...
	response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/8fe300e6-5a91-4295-b141-22549fe00a42/predictions?version=2022-11-15', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
